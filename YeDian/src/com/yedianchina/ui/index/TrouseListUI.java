...
import com.yedianchina.ui.index.TrainingListUI.CustomAdapter;

//服装列表 06-22
public class TrouseListUI extends Activity implements XListView.IXListViewListener{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			convertView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(TrouseListUI.this, ErshoushebeiDetailUI.class);
	...
	private void loadData() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Map resultMap = ErshoushebeiDao.pageList(currentPage, 2);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		IntentFilter filter = new IntentFilter(PublishTrouseUI.action);
			...
			publishBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (uid == 0) {
						...
						intent.setClass(TrouseListUI.this, LoginUI.class);

						TrouseListUI.this.startActivity(intent);

					} else if (uid > 0) {
						Intent intent = new Intent();
						intent.setClass(TrouseListUI.this,
								PublishTrouseUI.class);
