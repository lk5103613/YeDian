...
public class PublishErshouSheBeiUI extends CommonActivity {
...
//										requestURL);
		...
		if (photo0 != null) {
			photo0.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(PublishErshouSheBeiUI.this, CameraUI.class);
	...
	private Handler saveHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what==1){
				T.showShort(PublishErshouSheBeiUI.this, "发布成功");
				new Thread() {
					public void run() {
						try{
						Thread.sleep(2);
		...
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what==1){
				 Intent intent = new Intent(action);  
	                intent.putExtra("updateErShouSheBei", "1");  
	                sendBroadcast(intent);  
	            
				PublishErshouSheBeiUI.this.finish();
			}
		}
	};
	public static final String action = "erShoushebei.broadcast.action";  
