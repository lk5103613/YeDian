...
//服装 06-07
public class TrouseDetailUI extends CommonActivity implements
	...
	private void setGalleryFlow(){
		...
		ImageAdapter adapter = new ImageAdapter(TrouseDetailUI.this, imgList);
	...
	public void telFn() {
		mp = po.getLinkmp();
		AlertDialog.Builder alert = new AlertDialog.Builder(TrouseDetailUI.this);
			...
			favBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (uid == 0) {
						...
						intent.setClass(TrouseDetailUI.this, LoginUI.class);

						TrouseDetailUI.this.startActivity(intent);
					} else {
						new Thread() {
							public void run() {
	...
	public void onClick(View view) {
		try {
			if (view == buyBtn) {
				...
				//
				Intent intent = new Intent();
				intent.setClass(TrouseDetailUI.this, JobReqDetailUI.class);
		...
		protected Bitmap doInBackground(String... params) {
			...
			try {
				...
				if (isExists == false) {
					Net net = new Net();
					byte[] data = net
							.downloadResource(TrouseDetailUI.this, url);
