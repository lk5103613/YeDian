...
public class PublishTrainingUI extends CommonActivity {
		...
		if (photo0 != null) {
			photo0.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(PublishTrainingUI.this, CameraUI.class);
	...
	private Handler saveHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if (msg.what == 1) {
				T.showShort(PublishTrainingUI.this, "发布成功");
				new Thread() {
					public void run() {
						try {
							Thread.sleep(2);
	...
	private Handler closeHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if (msg.what == 1) {
				...
				intent.putExtra("updateTraining", "1");
				sendBroadcast(intent);

				PublishTrainingUI.this.finish();
			}
		}
	};
	public static final String action = "traininglist.broadcast.action";
