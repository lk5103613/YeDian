...
//二手设备详情 06-09
public class ErshoushebeiDetailUI extends CommonActivity implements
	...
	private void setGalleryFlow(){
		...
		ImageAdapter adapter = new ImageAdapter(ErshoushebeiDetailUI.this, imgList);
	...
	public void telFn() {
		mp = po.getLinkmp();
		AlertDialog.Builder alert = new AlertDialog.Builder(ErshoushebeiDetailUI.this);
	...
	Handler favHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			int what = msg.what;
			if (what == 1) {
...
//		avatarId= (ImageView) findViewById(R.id.avatarId);
			...
			favBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (uid == 0) {
						...
						intent.setClass(ErshoushebeiDetailUI.this, LoginUI.class);

						ErshoushebeiDetailUI.this.startActivity(intent);
					} else {
						new Thread() {
							public void run() {
								...
								favHandler.sendEmptyMessage(code);
		...
		//homeAddressTv = (TextView) this.findViewById(R.id.homeAddressTv);
		...
		//contentDescTv = (TextView) this.findViewById(R.id.contentDescTv);
		...
		if(backBtn!=null){
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View arg0) {
					ErshoushebeiDetailUI.this.finish();
	...
	public void onClick(View view) {
		try {
			if (view == buyBtn) {
				...
				//
				Intent intent = new Intent();
				intent.setClass(ErshoushebeiDetailUI.this, JobReqDetailUI.class);
		...
		protected Bitmap doInBackground(String... params) {
			...
			try {
				...
				if (isExists == false) {
					Net net = new Net();
					byte[] data = net
							.downloadResource(ErshoushebeiDetailUI.this, url);
