...
import com.yedianchina.ui.paidui.PaiDuiDetailUI;

//派对0804
public class PaiDuiListUI extends Activity implements XListView.IXListViewListener{
	...
	class CustomAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.paidui_cell, null);
			...
			convertView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(PaiDuiListUI.this, PaiDuiDetailUI.class);
	...
	private void loadData() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Map resultMap = PaiDuiDao.pageList(currentPage);
				List<PaiDuiPO> tmp = (List<PaiDuiPO>) resultMap.get("list");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (backBtn != null) {
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					PaiDuiListUI.this.finish();

				}
			});
		}

		list = new ArrayList<PaiDuiPO>();
		...
		// //////////////////////////////////////////////
		// 发布派对0804
		TextView publishActivityTv = (TextView) this
				.findViewById(R.id.publishActivityTv);
		if (publishActivityTv != null) {
			publishActivityTv.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View arg0) {
					intent.setClass(PaiDuiListUI.this, PublishPaiDuiUI.class);
		...
		IntentFilter filter = new IntentFilter(PaiDuiListUI.action);
	...
	BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			String updatePaiduiListFn = intent.getExtras().getString(
					"updatePaiduiListFn");
			if ("1".equals(updatePaiduiListFn)) {
				loadData();
			}
		}
	};
