...
public class PublishManageUI extends CommonActivity {
...
//										requestURL);
		...
		if (photo0 != null) {
			photo0.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(PublishManageUI.this, CameraUI.class);
	...
	private Handler saveHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what==1){
				T.showShort(PublishManageUI.this, "发布成功");
				new Thread() {
					public void run() {
						try{
						Thread.sleep(2);
		...
		public void handleMessage(android.os.Message msg) {
			...
			if(msg.what==1){
				 Intent intent = new Intent(action);  
	                ...
	                PublishManageUI.this.finish();
			}
		}
	};
	public static final String action = "training.broadcast.action";  
