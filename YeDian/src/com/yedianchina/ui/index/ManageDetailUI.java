...
//管理 06-07
public class ManageDetailUI extends CommonActivity implements
	...
	private void setGalleryFlow(){
		...
		ImageAdapter adapter = new ImageAdapter(ManageDetailUI.this, imgList);
	...
	public void telFn() {
		mp = po.getLinkmp();
		AlertDialog.Builder alert = new AlertDialog.Builder(ManageDetailUI.this);
			...
			favBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (uid == 0) {
						...
						intent.setClass(ManageDetailUI.this, LoginUI.class);

						ManageDetailUI.this.startActivity(intent);
					} else {
						new Thread() {
							public void run() {
	...
	public void onClick(View view) {
		try {
			if (view == buyBtn) {
				...
				//
				Intent intent = new Intent();
				intent.setClass(ManageDetailUI.this, JobReqDetailUI.class);
		...
		protected Bitmap doInBackground(String... params) {
			...
			try {
				...
				if (isExists == false) {
					Net net = new Net();
					byte[] data = net
							.downloadResource(ManageDetailUI.this, url);
