...
//二手设备列表 06-09
public class ErshoushebeiListUI extends Activity implements XListView.IXListViewListener{
			...
			if ("1".equals(flag)) {
		      ...
		      convertView.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						intent.setClass(ErshoushebeiListUI.this, ErshoushebeiDetailUI.class);
	...
	private void loadData() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Map resultMap = ErshoushebeiDao.pageList(currentPage, 1);
	...
	public void onCreate(Bundle savedInstanceState) {
			...
			publishBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (uid == 0) {
						...
						intent.setClass(ErshoushebeiListUI.this, LoginUI.class);

						ErshoushebeiListUI.this.startActivity(intent);

					} else if (uid > 0) {
						Intent intent = new Intent();
						intent.setClass(ErshoushebeiListUI.this,
								PublishErshouSheBeiUI.class);
		...
		if (backBtn != null) {
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View arg0) {
					ErshoushebeiListUI.this.finish();
		...
		cat_btn = (TextView) this.findViewById(R.id.cat_btn);
		cat_btn.setBackgroundDrawable(new BitmapDrawable(readBitMap(ErshoushebeiListUI.this, R.drawable.left_focus)));
		cat_btn.setTextColor(Color.parseColor("#FFFFFFFF"));
		//
		
		distance_btn = (TextView) this.findViewById(R.id.distance_btn);
		distance_btn.setBackgroundDrawable(new BitmapDrawable(readBitMap(ErshoushebeiListUI.this, R.drawable.right)));
		distance_btn.setTextColor(Color.parseColor("#ff404040"));
...
//		}.start();
		...
		IntentFilter filter = new IntentFilter(PublishErshouSheBeiUI.action);
