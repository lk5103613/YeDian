...
import com.yedianchina.ui.group.GroupListUI.CustomAdapter;
import com.yedianchina.ui.R;

//选择夜店   06-07
public class SelectMerchantListUI extends Activity
			...
			if("1".equals(flag)){
		      ...
		      convertView.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						  intent.setClass(SelectMerchantListUI.this, NearByMerchantDetailUI.class);
		...
		if (backBtn != null) {
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					SelectMerchantListUI.this.finish();
