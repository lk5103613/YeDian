...
import com.yedianchina.ui.i.IDynamicUI.CustomAdapter;
import com.yedianchina.ui.R;
import com.yedianchina.ui.YeDianChinaApplication;

public class IMainUI extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if(nearbyClassScoreID!=null){
        	nearbyClassScoreID.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					intent.setClass(IMainUI.this, IDengji.class);
					 
					IMainUI.this.startActivity(intent);
		...
		if(nearbyAttentionID!=null){
			nearbyAttentionID.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent();
					intent.setClass(IMainUI.this, IAttentionUI.class);
		...
		if(nearby_gz!=null){
			nearby_gz.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(uid==0){
						intent.setClass(IMainUI.this, LoginUI.class);
        ...
        nearby_sendmsg.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(IMainUI.this, ISendMsgUI.class);
		...
		if (mingpianBtn != null) {
			mingpianBtn.setText("发布");
			mingpianBtn.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View arg0) {
					Intent intent = new Intent();
					intent.setClass(IMainUI.this, IPublishUI.class);
		...
		loadData();
		TextView publishTv = (TextView) this
				.findViewById(R.id.mingpianBtn);
		if (publishTv != null) {
	...
	public class CustomAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			convertView.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View arg0) {
					intent.setClass(IMainUI.this, IDynamicDetailUI.class);
