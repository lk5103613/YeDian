...
//附近－》动态－》关注－》喜欢的夜店
public class AttentionMerchantListUI extends Activity implements
XListView.IXListViewListener{
	...
	class CustomAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.nearby_merchant_cell,
						null);
			...
			if("1".equals(flag)){
		      ...
		      convertView.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						intent.setClass(AttentionMerchantListUI.this, NearByMerchantDetailUI.class);
	...
	private void loadData() {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Map resultMap = AttentionDao.pageList(currentPage,pk);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (backBtn != null) {
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					AttentionMerchantListUI.this.finish();
        ...
        this.pk=this.getIntent().getExtras().getLong("pk",0);
