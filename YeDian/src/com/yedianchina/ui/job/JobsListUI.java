...
public class JobsListUI extends CommonActivity implements XListView.IXListViewListener{
	...
	class CustomAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.job_cell, null);
				...
				holder.ageTv = (TextView) convertView
				.findViewById(R.id.ageTv);
			...
			final JobsPO m = (JobsPO) _list.get(position);

			holder.titleTv.setText(m.getReqJobName());
			// holder.mpTv.setText(m.getLinkNumber());
			String url = m.getAvatar();//用户头像

			String trueName = m.getLinkman();
			if (trueName != null && trueName.length() > 0) {
				holder.addrTv.setText(trueName);
			}
		
			
			holder.logoImg.setBackgroundDrawable(new BitmapDrawable(readBitMap(JobsListUI.this, R.drawable.empty_photo)));
			...
			if ("1".equals(g)) {
				holder.merchantNameTv.setText("女");
			}else{
				holder.merchantNameTv.setText("男");
			}
			String add_time = m.getAddTime();
			if (add_time != null) {
				holder.addtimeTv.setText(add_time);
			}
			String age=m.getAge();
			if(age!=null&&age.length()>0&&!"null".equals(age)){
			holder.ageTv.setText(m.getAge());
			}else{
				holder.ageTv.setText("");
			}
		  final String  pk=m.getId();
	      convertView.setOnClickListener(new View.OnClickListener() {
				
				@Override
				public void onClick(View arg0) {
					intent.setClass(JobsListUI.this, JobReqDetailUI.class);
			...
			if (msg.what == 1) {
				...
				district_btn.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						baoxuan_popMenu = new PPCPopMenu(JobsListUI.this);
...
//						View contentView = getLayoutInflater().inflate(
//								R.layout.recruit_list, null, true);
						jobsPopMenu = new JobsPopMenu(JobsListUI.this,
								offset,yOffSet);
				...
				sex_btn.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						View contentView = getLayoutInflater().inflate(
								R.layout.recruit_list, null, true);
						sexPopMenu = new SexPopMenu(JobsListUI.this, offset);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout tool_bar1=(LinearLayout)this.findViewById(R.id.tool_bar1);
		...
		ktvBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				jiubaBtn.setBackgroundDrawable(new BitmapDrawable(readBitMap(
						JobsListUI.this, R.drawable.jb)));
				ktvBtn.setBackgroundDrawable(new BitmapDrawable(readBitMap(
						JobsListUI.this, R.drawable.ktv_focus)));
				yezonghuiBtn.setBackgroundDrawable(new BitmapDrawable(readBitMap(
						JobsListUI.this, R.drawable.yzh)));
		...
		yezonghuiBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ktvBtn.setBackgroundDrawable(new BitmapDrawable(readBitMap(
						JobsListUI.this, R.drawable.ktv)));
				yezonghuiBtn.setBackgroundDrawable(new BitmapDrawable(readBitMap(
						JobsListUI.this, R.drawable.yzh_focus)));
		...
		if (publishRecruitBtn != null) {
			publishRecruitBtn.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
						...
						Intent mainIntent = new Intent(JobsListUI.this,
								PublishJobUI.class);
						JobsListUI.this.startActivity(mainIntent);
