...
public class NearByMerchantMapUI extends CommonActivity {
			...
			try {
				...
				if (what == 1) {
					...
					for (UserPO po : list) {
						...
						button = new MyImageButton(NearByMerchantMapUI.this,
								R.drawable.star3, "");
						...
						MyAvatarButton avatarBtn = new MyAvatarButton(
								NearByMerchantMapUI.this, avatar);
						...
						button.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								intent.setClass(NearByMerchantMapUI.this,
										NearByMerchantMapUI.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (backBtn != null) {
			backBtn.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					NearByMerchantMapUI.this.finish();
	...
	Handler refreshYRHereHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (msg.what == 1) {
				...
				yrhereBtn = new CurrentButton(NearByMerchantMapUI.this, "您在这里");
