package com.yedianchina.service;
...
import com.yedianchina.tools.FileUtil;
import com.yedianchina.ui.R;
import com.yedianchina.ui.SplashUI;
...
public class UpdateService extends Service {
	...
	private static  String down_url = "http://115.28.107.87/YedianChina0731.apk";
	...
	public void createThread() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					//down_url = "http://ftptestdj.s709.000pc.net/daokuan_user.apk";
	...
	public void createNotification() {
		...
		notification = new Notification();
		 notification.icon = R.drawable.logo200;
		 // 这个参数是通知提示闪出来的值.
		 notification.tickerText = "开始下载";
		
		 updateIntent = new Intent(this, SplashUI.class);
